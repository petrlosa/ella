...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Listing.priority'
        db.alter_column(u'core_listing', 'priority', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))
        # Adding field 'Publishable.youtube_video'
        db.add_column(u'core_publishable', 'youtube_video',
                      self.gf('django.db.models.fields.CharField')(max_length=2048, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Publishable.priority'
        db.alter_column(u'core_publishable', 'priority', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'Author.user'
        db.alter_column(u'core_author', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpUser.User'], null=True))

    def backwards(self, orm):

        # Changing field 'Listing.priority'
        db.alter_column(u'core_listing', 'priority', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
        # Deleting field 'Publishable.youtube_video'
        db.delete_column(u'core_publishable', 'youtube_video')


        # Changing field 'Publishable.priority'
        db.alter_column(u'core_publishable', 'priority', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

        # Changing field 'Author.user'
        db.alter_column(u'core_author', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
    ...
    models = {
        ...
        'core.author': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mpUser.User']", 'null': 'True', 'blank': 'True'})
        },
        'core.category': {
        ...
        'core.listing': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'priority': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1', 'null': 'True', 'blank': 'True'}),
        ...
        'core.publishable': {
            ...
            'youtube_video': ('django.db.models.fields.CharField', [], {'max_length': '2048', 'null': 'True', 'blank': 'True'})
        },
        'core.related': {
        ...
        u'mpUser.user': {
            ...
            'tax': ('django.db.models.fields.CharField', [], {'max_length': '15', 'blank': 'True'}),
            'tin': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
